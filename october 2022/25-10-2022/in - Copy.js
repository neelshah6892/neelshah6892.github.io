...
let const1 = ["videos/WhatsApp Video 2024-07-03 at 10.10.10 PM.mp4"];
let const2 = ["videos/IMG_5411.MP4"];
let const3 = ["videos/WhatsApp Video 2024-07-03 at 10.10.10 PM.mp4"];
...
function handleOrientationChange() {
    ...
    if (isPortrait) {
        ...
        // } else if (!photosHidden) {
            // interval/d = setInterval(changePhoto, 6000);
        // }
    } else {
